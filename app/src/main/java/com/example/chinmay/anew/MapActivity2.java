...
public class MapActivity2 extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,LocationListener {
    ...
    private double latitudefromIntent,longitudefromIntent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(b!=null)
        {
            latitudefromIntent=b.getDouble("lat");
            longitudefromIntent=b.getDouble("long");
            savedposition=new LatLng(latitudefromIntent,longitudefromIntent);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        MarkerOptions saved=new MarkerOptions();
