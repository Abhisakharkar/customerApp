...
public class MyPlacesAdapter extends BaseAdapter implements Filterable {
    ...
    synchronized private ArrayList<MyGooglePlaces> getPredictions(String constraint)
    {
        ...
        String API_KEY="AIzaSyB9Zgb6Uw_WP5C1xYgmacF0Ce_2zlmUW20";
        String url= "https://maps.googleapis.com/maps/api/place/textsearch/json?query="+constraint+"&location=21.1458,79.25&radius=10000&key=AIzaSyB9Zgb6Uw_WP5C1xYgmacF0Ce_2zlmUW20";
    ...
    private synchronized static ArrayList parseGoogleParse(final String response) {
